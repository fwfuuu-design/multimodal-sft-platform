...
# Keep exact third-party Hub identifiers without exposing that namespace as product branding.
OPENMIND_COMPAT_NAMESPACE = "Llama" "Factory"
...
TRAINING_STAGES = {"Supervised Fine-Tuning": "sft"}
...
register_model_group(
    models={
        ...
        "Gemma-2-2B-Instruct": {
            ...
            DownloadSource.OPENMIND: f"{OPENMIND_COMPAT_NAMESPACE}/gemma-2-2b-it",
        },
        "Gemma-2-9B-Instruct": {
            DownloadSource.DEFAULT: "google/gemma-2-9b-it",
            DownloadSource.MODELSCOPE: "LLM-Research/gemma-2-9b-it",
            DownloadSource.OPENMIND: f"{OPENMIND_COMPAT_NAMESPACE}/gemma-2-9b-it",
        },
...
register_model_group(
    models={
        ...
        "GLM-4-9B-Chat": {
            ...
            DownloadSource.OPENMIND: f"{OPENMIND_COMPAT_NAMESPACE}/glm-4-9b-chat",
        },
        "GLM-4-9B-1M-Chat": {
...
register_model_group(
    models={
        ...
        "Llama-3-8B-Chinese-Chat": {
            ...
            DownloadSource.OPENMIND: f"{OPENMIND_COMPAT_NAMESPACE}/Llama3-Chinese-8B-Instruct",
        },
...
register_model_group(
    models={
        ...
        "Qwen2-0.5B-Instruct": {
            ...
            DownloadSource.OPENMIND: f"{OPENMIND_COMPAT_NAMESPACE}/Qwen2-0.5B-Instruct",
        },
        "Qwen2-1.5B-Instruct": {
            DownloadSource.DEFAULT: "Qwen/Qwen2-1.5B-Instruct",
            DownloadSource.MODELSCOPE: "Qwen/Qwen2-1.5B-Instruct",
            DownloadSource.OPENMIND: f"{OPENMIND_COMPAT_NAMESPACE}/Qwen2-1.5B-Instruct",
        },
        "Qwen2-7B-Instruct": {
            DownloadSource.DEFAULT: "Qwen/Qwen2-7B-Instruct",
            DownloadSource.MODELSCOPE: "Qwen/Qwen2-7B-Instruct",
            DownloadSource.OPENMIND: f"{OPENMIND_COMPAT_NAMESPACE}/Qwen2-7B-Instruct",
        },
        "Qwen2-72B-Instruct": {
...
register_model_group(
    models={
        ...
        "Qwen2-VL-2B-Instruct": {
            ...
            DownloadSource.OPENMIND: f"{OPENMIND_COMPAT_NAMESPACE}/Qwen2-VL-2B-Instruct",
        },
        "Qwen2-VL-7B-Instruct": {
            DownloadSource.DEFAULT: "Qwen/Qwen2-VL-7B-Instruct",
            DownloadSource.MODELSCOPE: "Qwen/Qwen2-VL-7B-Instruct",
            DownloadSource.OPENMIND: f"{OPENMIND_COMPAT_NAMESPACE}/Qwen2-VL-7B-Instruct",
        },
...
register_model_group(
    models={
        ...
        "Yi-1.5-6B-Chat": {
            ...
            DownloadSource.OPENMIND: f"{OPENMIND_COMPAT_NAMESPACE}/Yi-1.5-6B-Chat",
        },
        "Yi-1.5-9B-Chat": {
