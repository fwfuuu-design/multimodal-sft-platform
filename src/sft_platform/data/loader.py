...
from .processor import GenerationDatasetProcessor, PackedSupervisedDatasetProcessor, SupervisedDatasetProcessor
...
def _get_merged_dataset(
    ...
    for dataset_name, dataset_attr in zip(dataset_names, get_dataset_list(dataset_names, data_args.dataset_dir)):
        if stage != "sft":
            raise ValueError("Only supervised fine-tuning (SFT) datasets are available in this product.")
...
def _get_dataset_processor(
    ...
    r"""Return the SFT training or generation-evaluation dataset processor."""
    if stage != "sft":
        raise ValueError("Only supervised fine-tuning (SFT) is available in this product.")
    if do_generate:
        dataset_processor_class = GenerationDatasetProcessor
