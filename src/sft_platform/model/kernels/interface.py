...
from .device import DeviceType, get_current_accelerator
...
def apply_hardware_kernels(model: HFModel, enabled: bool) -> HFModel:
    """Apply automatic CUDA/NPU kernels without loading an alternate trainer framework."""
    if not enabled:
        return model
